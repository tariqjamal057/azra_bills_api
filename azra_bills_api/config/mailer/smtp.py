...
Dependencies:
    ...
    - azra_bills_api.config.logger.app: For logging.
    - azra_bills_api.config.mailer.base: For the base mail class.
"""
...
from azra_bills_api.config.mailer.base import BaseMail
